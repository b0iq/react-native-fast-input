...
import { ChangeEventPayload, ReactNativeFastInputViewProps } from './ReactNativeFastInput.types';
...
const emitter = new EventEmitter(ReactNativeFastInputModule ?? NativeModulesProxy.ReactNativeFastInput);

export function addChangeListener(listener: (event: ChangeEventPayload) => void): Subscription {
  return emitter.addListener<ChangeEventPayload>('onChange', listener);
}

export { ReactNativeFastInputView, ReactNativeFastInputViewProps, ChangeEventPayload };
